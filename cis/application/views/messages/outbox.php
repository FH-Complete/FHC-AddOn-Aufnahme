	...
	<div id="messages_outbox">
	    ...
	    <div id="message_<?php echo $msg->message_id; ?>" class="row message-item">
			...
			<div class="col-sm-8 message-title">
				<a class="collapsed" messageId="<?php echo $msg->message_id; ?>" data-toggle='collapse' data-target='#message_body_outbox_<?php echo $msg->message_id; ?>'>
...
<!--				<a href="<?php echo base_url($this->config->config['index_page'].'/Messages/answerMessage/'.$msg->message_id.'/'.$msg->oe_kurzbz); ?>">
			...
			<div id="message_body_outbox_<?php echo $msg->message_id; ?>" class="collapse message-body" style="float: left;">
				<?php echo $msg->body;?>
			</div>
	    </div>
	    <?php } ?>
