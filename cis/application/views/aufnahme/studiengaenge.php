<div class="tab-content">
	...
	<ul class="nav nav-pills nav-stacked">
		<?php foreach ($studiengaenge as $stg): ?>
			<li><a href="#" onclick="togglePanel(<?php echo $stg["stgkz"]; ?>);"><?php echo $stg["bezeichnung"]; ?></a></li>
			<div id="stg_<?php echo $stg["stgkz"]; ?>" class="panel row" style="display: none;">
				<div class="col-sm-3">
				...
				<div class="col-sm-9">
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group <?php echo (form_error("geburtsdatum") != "") ? 'has-error' : '' ?>">
								...
								<?php echo form_label($this->lang->line('global/geburtsdatum'), "geburtsdatum", array("name" => "geburtsdatum", "for" => "geburtsdatum", "class" => "control-label")) ?>
								<div class="col-sm-12">
									<div class="row">
					...
					<legend class=""><?php echo $this->lang->line("global/adresse"); ?></legend>
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group <?php echo (form_error("heimatadresse") != "") ? 'has-error' : '' ?>">
								<fieldset><?php echo $this->lang->line('global/heimatadresse'); ?></fieldset>
