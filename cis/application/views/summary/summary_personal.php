<fieldset><?php echo $this->getPhrase("PersonalInformation", $sprache); ?></fieldset>
...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="col-sm-6"><?php echo (isset($adresse->strasse) && ($adresse->strasse != null)) ? $adresse->strasse : $this->lang->line("summary_unvollstaendig"); ?></div>
    </div>
</div>
<div class="row">
    <div class="col-sm-6">
    ...
    <div class="col-sm-6">
        ...
        <div class="col-sm-6"><?php echo ((isset($adresse->strasse) && ($adresse->plz != null)) && (isset($adresse->strasse) && ($adresse->ort != null)))? $adresse->plz." ".$adresse->ort : $this->lang->line("summary_unvollstaendig"); ?></div>
    </div>
</div>
<div class="row">
    <div class="col-sm-6">
