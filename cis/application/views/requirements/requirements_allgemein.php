...
<div id="letztesZeugnis" class="row" style="display: none;">
	...
	<div class="form-group">
		...
		<div class="upload">
		    <?php echo form_input(array('id' => $this->config->config["dokumentTypen"]["letztGueltigesZeugnis"], 'name' => 'Sonst', "type" => "file")); ?>
