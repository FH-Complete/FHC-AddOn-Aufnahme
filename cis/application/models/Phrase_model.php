...
class Phrase_model extends MY_Model
{
    ...
    {
	if ($restquery = $this->rest->get('system/phrase/phrases', array("app"=>"aufnahme", "sprache"=>$sprache, "phrase"=>$phrase, "orgeinheit_kurzbz"=>$oe_kurzbz, "orgform_kurzbz"=>$orgform_kurzbz)))
	{
