...
class DokumentStudiengang_model extends REST_Model
{
    ...
    {
        return $this->load('crm/dokumentstudiengang/DokumentstudiengangByStudiengang_kz', array("studiengang_kz" => $studiengang_kz, "onlinebewerbung" => $onlinebewerbung, "pflicht" => $pflicht));
    }
